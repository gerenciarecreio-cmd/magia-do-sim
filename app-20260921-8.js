...
async function uploadCouplePhoto(){
  ...
  try{
    ...
    if(rpcError){console.error(rpcError);await sb.storage.from('couple-profile-photos').remove([path]);toast('Não foi possível salvar a foto no perfil.');return;}
